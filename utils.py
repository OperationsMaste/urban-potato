...
def create_ticket_image(event_title, name, qr_bytes):
    # create simple ticket image using Pillow
    ...
    # Load default fonts (Pillow default)
    try:
    ...
    draw.text((30, 180), "Entry: Please present this ticket and QR code at entry.", font=small_font, fill=(80,80,80))
